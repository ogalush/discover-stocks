...
def init_db():
    ...
    c.execute(
        ...
        """, (DBConfig.DB_NAME,))
    if c.fetchone()[0] == 0:
        c.execute("CREATE INDEX idx_survey_date_stock_code ON survey (survey_date(10), stock_code(5));")
    ...
    c.execute(
        ...
        """, (DBConfig.DB_NAME,))
    if c.fetchone()[0] == 0:
        c.execute("CREATE INDEX idx_vote_date_stock_code ON vote (vote_date(10), stock_code(5));")
